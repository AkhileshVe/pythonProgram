...
message = ["Enter 1 for all list",
           "Enter 2 for even list",
           "Enter 3 for odd list",
           "Enter 4 to search student detail by roll no.",
           "Enter 5 for all pass student list",
           "Enter 6 for all fail studentlist",
           "Enter 7 for all first division student list",
           "Enter 8 for all second division student list",
           "Enter 9 for all third division student list",
           "Enter 10 for who are fail in all subject",
           "Enter 11 for who are fail in 1 subject",
           "Enter 12 for who are fail in 2 subject"]
...
#  for all list 
    if(choice == 1):
        message.remove("Enter 1 for all list")
        print("\t\t\t\t   \t""All list (1)")
        print()
        print("\t"f"{'Roll':<6} {'Name':<12} {'Physics':<12} {'Chemistry':<12} {'Maths':<12} {'Total Mark':<12} {'Persentage':<12}")
        for x in rec: 
...
#  for evevn 
        ...
        message.remove("Enter 2 for even list")
        print("\t\t\t\t  \t""Even list (2)")
        print()
        print("\t"f"{'Roll':<6} {'Name':<12} {'Physics':<12} {'Chemistry':<12} {'Maths':<12} {'Total Mark':<12} {'Persentage':<12}")
        for x in rec: 
...
#  for odd 
        ...
        message.remove("Enter 3 for odd list")
        print("\t\t\t\t    \t""Odd list (3)")
        print()
        print("\t"f"{'Roll':<6} {'Name':<12} {'Physics':<12} {'Chemistry':<12} {'Maths':<12} {'Total Mark':<12} {'Persentage':<12}")
        for x in rec:
...
# # for ? roll number
        ...
        message.remove("Enter 4 to search student detail by roll no.")
...
#  who are pass ?
        ...
        message.remove("Enter 5 for all pass student list")
...
#  who are fail ?
        ...
        message.remove("Enter 6 for all fail studentlist")
...
#  who are first division ?
        ...
        message.remove("Enter 7 for all first division student list")
...
#  who are second division ?
        ...
        message.remove("Enter 8 for all second division student list")
 ...
 #  who are third division ?
        ...
        message.remove("Enter 9 for all third division student list")
 ...
 #  who are fail in all subject ?
        ...
        message.remove("Enter 10 for who are fail in all subject")
...
#  who are fail in one subject ?
        ...
        message.remove("Enter 11 for who are fail in 1 subject")
...
#  who are fail in two subject ?
        ...
        message.remove("Enter 12 for who are fail in 2 subject")
